# ﻿coding=utf8
# Pattern to Number. Transform from a DNA sequence to an integer by alphabetic order of all combinations.
# AA=0, AC=1, AG=2, AT=3, CA=4...
# Number to Pattern. Transform from an integer to DNA sequence combination
# CountingFrequencies: Makes an array of all k-mers, through all k-mers in a given sequence uses the array to count all appearings
# using PatternToNumber and NumberToPattern
# FindFrequentWordsBySorting: sorting appearances of k-mers, find the k-mers more frequents
